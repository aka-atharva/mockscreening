    ...
    >
      <Link href="/" className="flex items-center space-x-3 group">
        ...
        <div className="flex flex-col">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-600 font-bold text-xl md:text-2xl">
      ...
      <div className="flex items-center space-x-4">
        ...
        {user ? (
          ...
          <>
            <Link
              href="/login"
              className="inline-flex items-center px-4 py-2 rounded-md bg-purple-600 hover:bg-purple-700 text-white font-medium border border-purple-400 shadow-[0_0_15px_rgba(168,85,247,0.5)] transition-all duration-300 hover:scale-105"
            >
